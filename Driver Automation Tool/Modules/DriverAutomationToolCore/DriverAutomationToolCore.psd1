@{
    ...
    FunctionsToExport = @(
        ...
        'ConvertTo-DATPackageSourcePath',
        'New-DATConfigMgrPkg',
        ...
        'ConvertTo-DATCanonicalJson',
        'Get-DATDriverManifestContentHash',
        'Send-DATDriverManifest',
